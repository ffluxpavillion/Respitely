          ...
          <div className="mission__div-inner">
            ...
            <div className="mission__div-inner-container-2">
              <p className="mission__div-text">
                  SafeHavenTO is a full-stack & responsive web application designed
                  to help those experiencing homelessness in finding nearby shelters
                  based on their individual needs, and the latest updates from locations
                  around the city. This app leverages data provided by the City of
                  Toronto's Daily Shelter Occupancy Data API, via the city's Open Data
                  Portal initiative.
                <br />
                <br />
                ...
                information. There is a lack of centralized, up-to-date resources
                for individuals in need, causing difficulties in finding suitable
                shelters, especially during urgent situations.
                <br />
                <br />
                By seamlessly integrating modern design and functionality with an
                intuitive and reliable user experience, such an application
                holds the potential to revolutionize the way individuals experiencing
                homelessness access vital information.
                <br />
                <br />
                This platform aims to provide critical information, but also
                a sense of security during times of intense vulnerability. We believe that
                everyone deserves a SafeHaven, and we are committed to making that a reality.
              </p>
            </div>
